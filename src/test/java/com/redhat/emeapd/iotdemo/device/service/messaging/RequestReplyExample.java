...
public class RequestReplyExample {
	...
	try {
	    ...
	    // check out which request message a reply message is for. Here we use the
	    // MessageID as the
	    // correlation id (JMSCorrelationID). You don't have to use it though. You can
	    // use some arbitrary string for
	    // example.
	    ...
	    // there may be many requests and
	    // many replies.
